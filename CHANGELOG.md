...
Number of examples after 3.9: **796** (785 after 3.8 plus 11 client bulkWrite prose). Full-suite times after 3.8: standalone **2:13 / 183 pending**, replica set **6:23 / 67 pending**, sharded **8:17 / 77 pending**, load-balanced **5:22 / 116 pending**. Estimated pending after 3.9 (full suite not re-timed): standalone **~168**, replica set **~47**, sharded **~57**, load-balanced **~96**.
